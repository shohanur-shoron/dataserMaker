...
def main():
    ...
    output_csv = os.path.join(speakers_dir, "metadata.csv")
    ...
    for audio_file in audio_files:
        ...
        os.makedirs(speaker_folder_path, exist_ok=True)
        print("---------------------------------------------------------------------")
        ...
        for i, seg in enumerate(combined_segments, start=1):
            ...
            out_wav_name = f"{speaker_label}_audio_{i:04d}.wav"
        ...
        # Increment speaker index for the next audio file
        speaker_index += 1
